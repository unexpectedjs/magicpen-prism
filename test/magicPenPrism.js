...
describe('magicpen-prism', function () {
  ...
  it('should highlight GraphQL', function () {
    expect(
      magicPen
        .code(
          '{ myQuery(first: 5) { ...on MyPreferredType { isAwesome } } }',
          'application/graphql'
        )
        .toString('ansi'),
      'to equal',
  ...
  it('should highlight a Content-Security-Policy', function () {
    expect(
      magicPen
        .code(
          "script-src 'self' https://gofish.dk/ 'unsafe-inline'; default-src 'none'",
          'csp'
        )
        .toString('ansi'),
      'to equal',
      "\x1b[34m\x1b[38;5;162mscript-src\x1b[39m \x1b[90m\x1b[38;5;74m'self'\x1b[39m \x1b[90m\x1b[38;5;180mhttps://gofish.dk/\x1b[39m \x1b[90m\x1b[38;5;74m'unsafe-inline'\x1b[39m\x1b[90m\x1b[38;5;247m;\x1b[39m \x1b[34m\x1b[38;5;162mdefault-src\x1b[39m \x1b[90m\x1b[38;5;74m'none'\x1B[39m"
    );
  });
});
